(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('lodash.throttle')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'lodash.throttle'], factory) :
	(factory((global['react-lay-z-image'] = {}),global.React,global.PropTypes,global.throttle));
}(this, (function (exports,React,PropTypes,throttle) { 'use strict';
...
var LazyImage = function (_Component) {
  ...
  _createClass$1(LazyImage, [{
    ...
    value: function render() {
      ...
      return showImage ? React__default.createElement(Image, imageProps) : React__default.createElement('div', { ref: function ref(marker) {
